...
const studioOakGrandNote = makeVariantKeyNote(grandPianoNote, {
  hp: 42, bodyFreq: 250, bodyGain: 2.6, presenceFreq: 2350, presenceGain: 0.8, lp: 5600, roomMix: 0.12, outGain: 1.02
});
const skylineKeysNote = makeVariantKeyNote(grandPianoNote, {
  hp: 115, bodyFreq: 540, bodyGain: 0.5, presenceFreq: 3450, presenceGain: 3.4, lp: 7600, chorusMs: 7, chorusMix: 0.11, outGain: 0.84
});
const tapeGlowKeysNote = makeVariantKeyNote(synthKeysNote, {
  hp: 92, bodyFreq: 420, bodyGain: 1.0, presenceFreq: 2450, presenceGain: 1.3, lp: 5100, chorusMs: 14, chorusMix: 0.18, outGain: 0.88
});
const prismKeysNote = makeVariantKeyNote(fmBellKeysNote, {
  hp: 155, bodyFreq: 930, bodyGain: 0.2, presenceFreq: 4700, presenceGain: 4.2, lp: 9200, chorusMs: 5, chorusMix: 0.09, outGain: 0.72
});
const dreamstatePadNote = makeVariantKeyNote(analogPolyKeysNote, {
  hp: 70, bodyFreq: 720, bodyGain: 1.6, presenceFreq: 1800, presenceGain: 0.2, lp: 3600, chorusMs: 18, chorusMix: 0.24, roomMix: 0.14, outGain: 0.78
});
const novaSweepNote = makeVariantKeyNote(synthKeysNote, {
  hp: 120, bodyFreq: 600, bodyGain: 0.6, presenceFreq: 3200, presenceGain: 2.8, lp: 7000, chorusMs: 9, chorusMix: 0.13, outGain: 0.82
});
const midnightGlassNote = makeVariantKeyNote(fmBellKeysNote, {
  hp: 190, bodyFreq: 1300, bodyGain: -0.2, presenceFreq: 5600, presenceGain: 4.8, lp: 9800, roomMix: 0.16, outGain: 0.68
});
...
const reedVelvetNote = makeVariantKeyNote(uprightPianoNote, {
  hp: 68, bodyFreq: 280, bodyGain: 3.0, presenceFreq: 1500, presenceGain: 0.3, lp: 2950, outGain: 1.00
});
