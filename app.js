...
function startDrums(){
  ...
  const runDrumStep = () => {
    ...
    if(state.drumStyle === "rap"){
      if(s === 0 || s === 8) drumHit("kick", 1.0);
      if(s === 4 || s === 12) drumHit("snare", 0.96);
      drumHit("hat", s % 4 === 2 ? 0.72 : 0.86);
    } else if(state.drumStyle === "rock"){
      if(s === 0 || s === 8) drumHit("kick", 0.98);
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s % 2 === 0) drumHit("hat", 0.78);
    } else if(state.drumStyle === "hardrock"){
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s === 0 || s === 3 || s === 6 || s === 8 || s === 11 || s === 14) drumHit("kick", 1.0);
      drumHit("hat", s % 2 === 0 ? 0.84 : 0.72);
    } else if(state.drumStyle === "pop"){
      if(s === 0 || s === 7 || s === 8) drumHit("kick", 0.98);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      if(s % 2 === 0) drumHit("hat", s === 14 ? 0.9 : 0.72);
    } else if(state.drumStyle === "modernrock"){
      if(s === 0 || s === 5 || s === 8 || s === 11) drumHit("kick", 1.0);
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s % 2 === 0) drumHit("hat", 0.82);
    } else if(state.drumStyle === "popbounce"){
      if(s === 0 || s === 6 || s === 8 || s === 14) drumHit("kick", 0.96);
      if(s === 4 || s === 12) drumHit("snare", 0.94);
      drumHit("hat", s % 4 === 3 ? 0.68 : 0.8);
    } else if(state.drumStyle === "trapphantom"){
      if(s === 0 || s === 3 || s === 8 || s === 10 || s === 14) drumHit("kick", 1.0);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      drumHit("hat", 0.78);
    } else if(state.drumStyle === "altpop"){
      if(s === 0 || s === 5 || s === 8 || s === 13) drumHit("kick", 0.95);
      if(s === 4 || s === 12) drumHit("snare", 0.96);
      if(s % 2 === 0 || s === 11 || s === 15) drumHit("hat", 0.76);
    } else {
      if(s === 0 || s === 7 || s === 8) drumHit("kick", 0.98);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
