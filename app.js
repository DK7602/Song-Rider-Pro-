...
function startDrums(){
  ...
  const runDrumStep = () => {
    ...
    if(state.drumStyle === "rap"){
      // 1 - Iron Highway
      if(s === 0 || s === 3 || s === 8 || s === 10) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.82);
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s % 2 === 0) drumHit("hat", s === 14 ? 0.84 : 0.76);
      if(s === 14) drumHit("tommid", 0.22);
      if(s === 15) drumHit("openhat", 0.42);
    } else if(state.drumStyle === "rock"){
      // 2 - Chrome Uprising
      if(s === 0 || s === 3 || s === 6 || s === 8 || s === 10 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.84);
      if(s === 4 || s === 12) drumHit("snare", 1.04);
      if(s % 2 === 0) drumHit("hat", 0.82);
      if(s === 13) drumHit("tommid", 0.24);
      if(s === 14) drumHit("tomhi", 0.20);
      if(s === 15) drumHit("openhat", 0.48);
    } else if(state.drumStyle === "hardrock"){
      // 3 - Midnight Silk
      if(s === 0 || s === 7 || s === 8 || s === 10 || s === 14) drumHit("kick", s === 0 || s === 8 ? 0.98 : 0.76);
      if(s === 4 || s === 12) drumHit("snare", 0.94);
      if(s === 0 || s === 2 || s === 6 || s === 8 || s === 10 || s === 14) drumHit("hat", 0.62);
      if(s === 13) drumHit("tomhi", 0.18);
      if(s === 15) drumHit("openhat", 0.24);
    } else if(state.drumStyle === "pop"){
      // 4 - Neon Kisser
      if(s === 0 || s === 6 || s === 8 || s === 11 || s === 14) drumHit("kick", s === 0 || s === 8 ? 0.98 : 0.78);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      if(s % 2 === 0) drumHit("hat", s === 14 ? 0.84 : 0.68);
      if(s === 10) drumHit("tomhi", 0.16);
      if(s === 15) drumHit("openhat", 0.28);
    } else if(state.drumStyle === "modernrock"){
      // 5 - Starlight Candy
      if(s === 0 || s === 5 || s === 8 || s === 13) drumHit("kick", s === 0 || s === 8 ? 0.96 : 0.76);
      ...
      // 6 - 808 Revenant
      if(s === 0 || s === 3 || s === 8 || s === 10 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.80);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      ...
      // 9 - Thunder Run
      if(s === 0 || s === 2 || s === 5 || s === 8 || s === 10 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.84);
      if(s === 4 || s === 12) drumHit("snare", 1.06);
      if(s % 2 === 0) drumHit("hat", 0.80);
      if(s === 13) drumHit("tommid", 0.24);
      if(s === 14) drumHit("tomhi", 0.20);
      if(s === 15) drumHit("openhat", 0.50);
    } else if(state.drumStyle === "sunsetrb"){
      // 10 - Velvet Afterglow
      if(s === 0 || s === 7 || s === 8 || s === 11 || s === 14) drumHit("kick", s === 0 || s === 8 ? 0.98 : 0.72);
    ...
    } else if(state.drumStyle === "glosspop"){
      // 11 - Sugar Voltage
      if(s === 0 || s === 4 || s === 6 || s === 8 || s === 11 || s === 14) drumHit("kick", s === 0 || s === 8 ? 0.98 : 0.76);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      if(s % 2 === 0) drumHit("hat", 0.70);
      if(s === 10) drumHit("tomhi", 0.16);
      if(s === 15) drumHit("openhat", 0.30);
    } else if(state.drumStyle === "stadiumpop"){
      // 12 - Skyline Sparks
      if(s === 0 || s === 3 || s === 8 || s === 11 || s === 14) drumHit("kick", s === 0 || s === 8 ? 0.98 : 0.76);
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s % 2 === 0) drumHit("hat", 0.74);
      if(s === 13) drumHit("tommid", 0.20);
      if(s === 15) drumHit("openhat", 0.34);
    } else if(state.drumStyle === "trapvenom"){
      // 13 - Venom Bounce
      if(s === 0 || s === 5 || s === 7 || s === 8 || s === 10 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.78);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      if(s !== 4 && s !== 12) drumHit("hat", (s % 2 === 0) ? 0.46 : 0.34);
      if(s === 13) drumHit("tommid", 0.18);
      if(s === 15) drumHit("openhat", 0.24);
    } else if(state.drumStyle === "drillghost"){
      // 14 - Ghost Cartel
      if(s === 0 || s === 3 || s === 8 || s === 9 || s === 11 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.78);
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s !== 4 && s !== 12) drumHit("hat", (s === 2 || s === 6 || s === 10 || s === 14) ? 0.50 : 0.34);
      if(s === 7) drumHit("tomhi", 0.14);
      if(s === 15) drumHit("openhat", 0.24);
    } else if(state.drumStyle === "southernsmoke"){
      // 15 - Southern Smoke
      if(s === 0 || s === 6 || s === 8 || s === 10 || s === 13 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.80);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      if(s !== 4 && s !== 12) drumHit("hat", (s % 2 === 0) ? 0.44 : 0.32);
      if(s === 13) drumHit("tommid", 0.20);
      if(s === 15) drumHit("openhat", 0.26);
    } else if(state.drumStyle === "blackout"){
      // 16 - Blackout Ritual
      if(s === 0 || s === 2 || s === 7 || s === 8 || s === 11 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.78);
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s !== 4 && s !== 12) drumHit("hat", (s % 2 === 0) ? 0.42 : 0.32);
      if(s === 6) drumHit("tomhi", 0.16);
      if(s === 13) drumHit("tommid", 0.18);
      if(s === 15) drumHit("openhat", 0.24);
    } else {
