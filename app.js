...
async function insertNotesImageFromFile(file){
  ...
  restoreNotesSelection();
  const html = `<div class="notesImageBlock" contenteditable="false" data-notes-image-id="${imageId}"><img class="notesImage" data-notes-image-id="${imageId}" alt="${escapeHtml(file.name || 'Photo')}" loading="lazy" decoding="async"></div><div><br></div>`;
  try{
