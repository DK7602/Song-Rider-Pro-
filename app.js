...
function renderProjectsDropdown(){
  const active = getVisibleProjects();
  ...
  let list = [...active].sort((a,b) => compareProjectsBySort(a,b,sort));
  ...
  if(el.projectSelect.options.length === 0 || (el.projectSelect.options.length === 1 && el.projectSelect.options[0].value === "")){
    const p = defaultProject("New Song");
    upsertProject(p);
    state.project = p;
    renderProjectsDropdown();
