...
function startDrums(){
  ...
  const runDrumStep = () => {
    ...
    if(state.drumStyle === "rock"){
      ...
      if(s === 15) drumHit("openhat", 0.44);
      if(s === 14) drumHit("tommid", 0.24);
    } else if(state.drumStyle === "hardrock"){
      // 2 Rock - Granite Drive
      if(s === 0 || s === 3 || s === 6 || s === 8 || s === 10 || s === 13 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.86);
      if(s === 4 || s === 12) drumHit("snare", 1.04);
      if(s % 2 === 0) drumHit("hat", 0.82);
      if(s === 13) drumHit("tomhi", 0.22);
      if(s === 14) drumHit("tommid", 0.24);
      if(s === 15) drumHit("openhat", 0.5);
    } else if(state.drumStyle === "arena"){
      // 3 Rock - Stadium Riot
      if(s === 0 || s === 5 || s === 8 || s === 10 || s === 11 || s === 14) drumHit("kick", s === 0 || s === 8 ? 0.98 : 0.8);
      if(s === 4 || s === 12) drumHit("snare", 1.02);
      if(s === 0 || s === 2 || s === 4 || s === 6 || s === 8 || s === 10 || s === 12 || s === 14) drumHit("hat", 0.7);
      if(s === 7) drumHit("openhat", 0.3);
      if(s === 13) drumHit("tomhi", 0.18);
      if(s === 15) drumHit("tommid", 0.26);
    } else if(state.drumStyle === "southernrock"){
      // 4 Rock - Diesel Anthem
      if(s === 0 || s === 2 || s === 8 || s === 9 || s === 10 || s === 14) drumHit("kick", s === 0 || s === 8 ? 0.98 : 0.78);
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s % 2 === 0) drumHit("hat", 0.74);
      if(s === 6) drumHit("openhat", 0.26);
      if(s === 15) drumHit("openhat", 0.4);
      if(s === 13) drumHit("tomhi", 0.2);
      ...
      if(s === 15) drumHit("openhat", 0.32);
      if(s === 10) drumHit("tomhi", 0.14);
      if(s === 13) drumHit("tommid", 0.22);
    } else if(state.drumStyle === "electropop"){
      // 7 Pop - Sunset Circuit
      if(s === 0 || s === 7 || s === 8 || s === 10 || s === 12 || s === 14) drumHit("kick", s === 0 || s === 8 ? 0.96 : 0.72);
      if(s === 4 || s === 12) drumHit("snare", 0.94);
      if(s === 0 || s === 2 || s === 4 || s === 6 || s === 8 || s === 10 || s === 12 || s === 14) drumHit("hat", 0.64);
      if(s === 3 || s === 11) drumHit("openhat", 0.24);
      if(s === 15) drumHit("tomhi", 0.2);
    } else if(state.drumStyle === "powerpop"){
      // 8 Pop - Sugar Satellite
      if(s === 0 || s === 4 || s === 6 || s === 8 || s === 11 || s === 14) drumHit("kick", s === 0 || s === 8 ? 0.98 : 0.74);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      if(s % 2 === 0) drumHit("hat", 0.7);
      if(s === 7) drumHit("openhat", 0.26);
      if(s === 13) drumHit("tomhi", 0.16);
      if(s === 15) drumHit("tommid", 0.2);
      ...
      if(s === 3 || s === 11 || s === 15) drumHit("openhat", 0.18);
      if(s === 13) drumHit("tomhi", 0.14);
    } else if(state.drumStyle === "rnblate"){
      // 10 R&B - Midnight Silk
      if(s === 0 || s === 5 || s === 8 || s === 10 || s === 13) drumHit("kick", s === 0 || s === 8 ? 0.96 : 0.7);
      if(s === 4 || s === 12) drumHit("snare", 0.9);
      if(s === 0 || s === 3 || s === 6 || s === 8 || s === 10 || s === 14) drumHit("hat", 0.52);
      if(s === 7 || s === 15) drumHit("openhat", 0.2);
      if(s === 14) drumHit("tommid", 0.16);
    } else if(state.drumStyle === "rap"){
      // 11 Trap - 808 Revenant
      if(s === 0 || s === 3 || s === 8 || s === 10 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.78);
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      if(s === 1 || s === 2 || s === 3 || s === 5 || s === 6 || s === 7 || s === 9 || s === 10 || s === 11 || s === 13 || s === 14 || s === 15) drumHit("hat", (s % 2 === 0) ? 0.48 : 0.36);
      if(s === 13) drumHit("tommid", 0.2);
      ...
      if(s === 4 || s === 12) drumHit("snare", 0.98);
      if(s === 1 || s === 2 || s === 3 || s === 5 || s === 6 || s === 7 || s === 9 || s === 10 || s === 11 || s === 13 || s === 14 || s === 15) drumHit("hat", (s === 2 || s === 6 || s === 10 || s === 14) ? 0.48 : 0.34);
      if(s === 13) drumHit("tomhi", 0.18);
      if(s === 15) drumHit("openhat", 0.24);
    } else if(state.drumStyle === "trapglide"){
      // 14 Trap - Ghost Drip
      if(s === 0 || s === 5 || s === 8 || s === 12 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.74);
      if(s === 4 || s === 12) drumHit("snare", 0.96);
      if(s !== 4 && s !== 12) drumHit("hat", (s % 2 === 0) ? 0.4 : 0.3);
      if(s === 6 || s === 15) drumHit("openhat", 0.2);
      if(s === 13) drumHit("tommid", 0.18);
    } else if(state.drumStyle === "trapriot"){
      // 15 Trap - Southside Hex
      if(s === 0 || s === 1 || s === 7 || s === 8 || s === 10 || s === 13 || s === 15) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.78);
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s !== 4 && s !== 12) drumHit("hat", (s % 2 === 0) ? 0.44 : 0.34);
      if(s === 11) drumHit("openhat", 0.18);
      if(s === 14) drumHit("tomhi", 0.16);
    } else if(state.drumStyle === "trapstorm"){
      // 16 Trap - Blackout Cartel
      if(s === 0 || s === 4 || s === 6 || s === 8 || s === 10 || s === 11 || s === 14) drumHit("kick", s === 0 || s === 8 ? 1.0 : 0.8);
      if(s === 4 || s === 12) drumHit("snare", 1.0);
      if(s !== 4 && s !== 12) drumHit("hat", (s % 2 === 0) ? 0.46 : 0.34);
      if(s === 7 || s === 15) drumHit("openhat", 0.22);
      if(s === 13) drumHit("tomhi", 0.16);
      if(s === 14) drumHit("tommid", 0.2);
    } else {
    ...
    step++;
    const nextAt = state.ctx ? (state.ctx.currentTime * 1000 + stepMs) : (Date.now() + stepMs);
    state.drumTimer = setTimeout(runDrumStep, Math.max(0, nextAt - (state.ctx ? state.ctx.currentTime * 1000 : Date.now())));
  };
...
function ensureCapoStepToggle(){
  try{
    const input = el && el.capoInput ? el.capoInput : document.getElementById("capoInput");
    ...
    if(!btn){
      ...
      btn.setAttribute("aria-label", "Toggle capo or step mode");
      btn.addEventListener("click", () => {
        if(!state || !state.project) return;

        editProject("transposeMode", () => {
          const nextMode = (state.transposeMode === "step") ? "capo" : "step";
          state.transposeMode = nextMode;
          state.project.transposeMode = nextMode;
        });

        if(state.transposeMode === "step"){
          input.step = "0.5";
          input.inputMode = "decimal";
          input.value = String(Number.isFinite(Number(state.steps)) ? roundToHalf(Number(state.steps)) : 0);
        }else{
          input.step = "1";
          input.inputMode = "numeric";
          input.value = String(clamp(parseInt(state.capo, 10) || 0, 0, 12));
        }
    ...
    if(btn.parentElement !== input.parentElement){
      if(input.nextSibling) input.parentElement.insertBefore(btn, input.nextSibling);
      else input.parentElement.appendChild(btn);
    }

    const isStep = !!(state && state.transposeMode === "step");
    btn.textContent = isStep ? "STEP" : "CAPO";
    btn.title = isStep ? "Step mode" : "Capo mode";
    btn.classList.toggle("on", isStep);

    input.step = isStep ? "0.5" : "1";
    input.inputMode = isStep ? "decimal" : "numeric";

    return btn;
  }catch(err){
    console.error("ensureCapoStepToggle failed", err);
    return null;
  }
}
